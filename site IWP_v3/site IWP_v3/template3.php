...
<body>
    ...
    <section id="about-sc" class="">
        <div class="container">
            <div class="about-cnt">
                <form action="cvdata3.php" class="cv-form" id="cv-form" method="post">
                            ...
                            <div class="cols-3">
                                <div class="form-elem">
                                    ...
                                    <input name="firstname" type="text" class="form-control firstname" id=""
                                        onkeyup="generateCV()" placeholder="e.g. John" value="<?php echo $_SESSION['firstname']; ?>">
                                ...
                                <div class="form-elem">
                                    ...
                                    <input name="middlename" type="text" class="form-control middlename" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Herbert" value="<?php echo $_SESSION['middlename']; ?>">
                                    <span class="form-text"></span>
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Last Name</label>
                                    <input name="lastname" type="text" class="form-control lastname" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Doe" value="<?php echo $_SESSION['lastname']; ?>">
                                    <span class="form-text"></span>
                                </div>
                            </div>
                            ...
                            <div class="cols-3">
                                <div class="form-elem">
                                    ...
                                    <input name="image" type="file" class="form-control image" id="" accept="image/*"
                                        onchange="previewImage()" value="<?php echo $_SESSION['image']; ?>">
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Designation</label>
                                    <input name="designation" type="text" class="form-control designation" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Sr.Accountants" value="<?php echo $_SESSION['designation']; ?>">
                                    <span class="form-text"></span>
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Address</label>
                                    <input name="address" type="text" class="form-control address" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Lake Street-23" value="<?php echo $_SESSION['address']; ?>">
                                    <span class="form-text"></span>
                                </div>
                            </div>
                            ...
                            <div class="cols-3">
                                <div class="form-elem">
                                    ...
                                    <input name="email" type="text" class="form-control email" id=""
                                        onkeyup="generateCV()" placeholder="e.g. johndoe@gmail.com" value="<?php echo $_SESSION['email']; ?>">
                                    <span class="form-text"></span>
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Phone No:</label>
                                    <input name="phoneno" type="text" class="form-control phoneno" id=""
                                        onkeyup="generateCV()" placeholder="e.g. 456-768-798, 567.654.002" value="<?php echo $_SESSION['phoneno']; ?>">
                                    <span class="form-text"></span>
                                </div>
                                <div class="form-elem">
                                    <label for="" class="form-label">Summary</label>
                                    <input name="summary" type="text" class="form-control summary" id=""
                                        onkeyup="generateCV()" placeholder="e.g. Doe" value="<?php echo $_SESSION['summary']; ?>">
                                    <span class="form-text"></span>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="cols-2">
                                            <div class="form-elem">
                                                ...
                                                <input name="achieve_title" type="text"
                                                    ...
                                                    placeholder="e.g. johndoe@gmail.com" value="<?php echo $_SESSION['achieve_title']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                ...
                                                <input name="achieve_description" type="text"
                                                    ...
                                                    onkeyup="generateCV()" placeholder="e.g. johndoe@gmail.com" value="<?php echo $_SESSION['achieve_description']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cols-3">
                                            <div class="form-elem">
                                                ...
                                                <input name="exp_title" type="text" class="form-control exp_title" id=""
                                                    onkeyup="generateCV()" value="<?php echo $_SESSION['exp_title']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">Company / Organization</label>
                                                <input name="exp_organization" type="text"
                                                    class="form-control exp_organization" id="" onkeyup="generateCV()" value="<?php echo $_SESSION['exp_organization']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">Location</label>
                                                <input name="exp_location" type="text" class="form-control exp_location"
                                                    id="" onkeyup="generateCV()" value="<?php echo $_SESSION['exp_location']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cols-3">
                                            <div class="form-elem">
                                                ...
                                                <input name="exp_start_date" type="date"
                                                    class="form-control exp_start_date" id="" onkeyup="generateCV()" value="<?php echo $_SESSION['exp_start_date']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">End Date</label>
                                                <input name="exp_end_date" type="date" class="form-control exp_end_date"
                                                    id="" onkeyup="generateCV()" value="<?php echo $_SESSION['exp_end_date']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">Description</label>
                                                <input name="exp_description" type="text"
                                                    class="form-control exp_description" id="" onkeyup="generateCV()" value="<?php echo $_SESSION['exp_description']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cols-3">
                                            <div class="form-elem">
                                                ...
                                                <input name="edu_school" type="text" class="form-control edu_school"
                                                    id="" onkeyup="generateCV()" value="<?php echo $_SESSION['edu_school']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">Degree</label>
                                                <input name="edu_degree" type="text" class="form-control edu_degree"
                                                    id="" onkeyup="generateCV()" value="<?php echo $_SESSION['edu_degree']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">City</label>
                                                <input name="edu_city" type="text" class="form-control edu_city" id=""
                                                    onkeyup="generateCV()" value="<?php echo $_SESSION['edu_city']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cols-3">
                                            <div class="form-elem">
                                                ...
                                                <input name="edu_start_date" type="date"
                                                    class="form-control edu_start_date" id="" onkeyup="generateCV()" value="<?php echo $_SESSION['edu_start_date']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">End Date</label>
                                                <input name="edu_graduation_date" type="date"
                                                    ...
                                                    onkeyup="generateCV()" value="<?php echo $_SESSION['edu_graduation_date']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">Description</label>
                                                <input name="edu_description" type="text"
                                                    class="form-control edu_description" id="" onkeyup="generateCV()" value="<?php echo $_SESSION['edu_description']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cols-3">
                                            <div class="form-elem">
                                                ...
                                                <input name="proj_title" type="text" class="form-control proj_title"
                                                    id="" onkeyup="generateCV()" value="<?php echo $_SESSION['proj_title']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">Project link</label>
                                                <input name="proj_link" type="text" class="form-control proj_link" id=""
                                                    onkeyup="generateCV()" value="<?php echo $_SESSION['proj_link']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                            <div class="form-elem">
                                                <label for="" class="form-label">Description</label>
                                                <input name="proj_description" type="text"
                                                    class="form-control proj_description" id="" onkeyup="generateCV()" value="<?php echo $_SESSION['proj_description']; ?>">
                                                <span class="form-text"></span>
                                            </div>
                                        </div>
                                        <button data-repeater-delete type="button"
                                    ...
                                    <div class="cv-form-row cv-form-row-skills">
                                        <div class="form-elem">
                                            ...
                                            <input name="skill" type="text" class="form-control skill" id=""
                                                onkeyup="generateCV()" value="<?php echo $_SESSION['skill']; ?>">
                                            <span class="form-text"></span>
                                        </div>
    ...
    <section id="preview-sc" class="print_area">
        <div class="container">
            <div class="preview-cnt">
                <div class="preview-cnt-l bg-grey text-white">
